...
class FormularioAluno(forms.Form):
    ...
    senha = forms.CharField(label='Senha', max_length=50, widget=forms.PasswordInput(attrs={'class':'form-control', 'placeholder':'Digite sua Senha'}))
    senha_confirmacao = forms.CharField(label='Confirme a senha', max_length=50, widget=forms.PasswordInput(attrs={'class':'form-control', 'placeholder':'Confirme sua senha'}))
    ...
    # estado= forms.CharField(label='Estado',max_length=50,widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Digite o estado'}))
